...
Scheduler-floor/client-LR interaction found a new best at `cosine_lr_eta_min_factor=0.003 --lr 0.0475`; server-LR and server-momentum neighbors regressed. Watchdog recommends continuing; next CLI-only continuation should probe regularization interactions around this stack before changing code again.
