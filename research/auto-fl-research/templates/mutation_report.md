...
Class-balanced loss failed and was reverted; post-mixup epoch-count and server-momentum audits regressed. Client LR `0.055` nearly cleared the threshold, so narrow around it with a CLI-only LR sweep before moving to another axis.
