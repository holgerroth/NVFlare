...
Class-balanced loss failed and was reverted; post-mixup epoch-count, server-momentum, client-LR, FedDyn-alpha, FedDrift-mu, and FedDrift-beta audits regressed or failed to clear the material threshold. Next CLI-only continuation should run regularizer-ablation probes before changing code again.
