...
Class-balanced loss failed and was reverted; post-mixup epoch-count, server-momentum, client-LR, drift-scalar retunes, and drift ablations regressed or failed to clear the material threshold. Next CLI-only continuation should retry scheduler-floor values under mixup before changing code again.
