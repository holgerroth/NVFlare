...
Class-balanced loss failed and was reverted; post-mixup epoch-count, server-momentum, client-LR, FedDyn-alpha, and FedDrift-mu audits regressed or failed to clear the material threshold. Next CLI-only continuation should retune `feddrift_beta` under mixup.
