...
Scheduler-floor/client-LR interaction found a new best at `cosine_lr_eta_min_factor=0.003 --lr 0.0475`. Watchdog reset on that material improvement and recommends continuing; next CLI-only continuation should probe conservative server optimizer or regularization interactions around this stack before changing code again.
