...
Class-balanced loss failed and was reverted; post-mixup epoch-count and server-momentum audits regressed. Avoid more client-loss code until another literature reset; next CLI-only continuation should probe a non-loss axis not already exhausted under mixup.
