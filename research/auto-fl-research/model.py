...
class ModerateCNNHighDropout(nn.Module):
    """Same trunk + head as ModerateCNN with stronger dropout regularization."""
...
MODEL_ARCHITECTURES = {
    ...
    "moderate_cnn_high_dropout": ModerateCNNHighDropout,
}
