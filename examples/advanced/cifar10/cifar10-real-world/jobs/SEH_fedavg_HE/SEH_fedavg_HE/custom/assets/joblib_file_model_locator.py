...
from assets.he_joblib_model_param_persistor import HEJoblibModelParamPersistor


class JoblibFileModelLocator(ModelLocator):
    def __init__(self, persistor_id: str):
    ...
    def _initialize(self, fl_ctx: FLContext):
        ...
        if self.model_persistor is None or not isinstance(self.model_persistor, HEJoblibModelParamPersistor):
            raise ValueError(
                f"persistor_id component must be HEJoblibModelParamPersistor. "
