...
[FL simulator](https://nvflare.readthedocs.io/en/latest/user_guide/nvflare_cli/fl_simulator.html) using the **SimEnv**.

### [Real-world Federated Learning with CIFAR-10](./pt/cifar10-real-world/README.md)
Real-world FL deployment requires secure provisioning and the admin API to submit jobs via **ProdEnv**. 
