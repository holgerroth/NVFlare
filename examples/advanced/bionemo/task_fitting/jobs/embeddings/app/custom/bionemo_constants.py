...
from bionemo_inferer import BioNeMoModelSharer
...
class BioNeMoInference(BroadcastAndProcess):
    def __init__(
        ...
        Args:
            config_dir: BioNeMo inference config directory
        ...
        BroadcastAndProcess.__init__(
            self,
            processor=BioNeMoModelSharer(config_dir=config_dir),
            task_name=task_name,
