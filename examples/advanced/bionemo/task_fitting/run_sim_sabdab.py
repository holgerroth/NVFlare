...
simulator = SimulatorRunner(
    ...
    #workspace=f"./results/local_finetune_esm1nv_enclr1e-5_maxepochs500_JoinedChains_alpha10_bs32",
    #job_folder="jobs/fedavg_sabdab_esm1nv",
    #workspace=f"./results/fedavg_finetune_esm1nv_enclr1e-5_maxepochs500_JoinedChains_alpha10_bs32",
    n_clients=n_clients,
    threads=n_clients
)
