...
## ---------------------------------------------------------------------------
##
## File: newton_raphson_workflow.py for Newton Raphson
##
## Created by Zhijin Li
## E-mail:   <zhijinl@nvidia.com>
##
## Started on  Mon Apr  8 14:17:26 2024 Zhijin Li
## Last update Mon Apr 15 02:13:10 2024 Zhijin Li
## ---------------------------------------------------------------------------
...
class FedAvgNewtonRaphson(BaseFedAvg):
  ...
  def run(self) -> None:
    ...
    for self.current_round in range(self.start_round, self.start_round + self.num_rounds):
      ...
      aggregate_results = self.aggregate(
        results,
        aggregate_fn=self.newton_raphson_aggregator_fn)
  ...
  def newton_raphson_aggregator_fn(
      self,
    ...
    newton_raphson_updates = self.damping_factor * np.linalg.solve(
      aggregated_dict['hessian'] + reg,
      aggregated_dict['gradient']
    )
    ...
    aggr_result = FLModel(
      params={
        'newton_raphson_updates': newton_raphson_updates
      },
