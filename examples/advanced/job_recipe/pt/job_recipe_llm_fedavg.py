...
if __name__ == "__main__":
    ...
    recipe.execute(
        env=SimEnv(clients=["dolly", "alpaca", "oasst1"], gpu="[0,1],[2,3],[0,1]", workdir="/tmp/nvflare/llm_fedavg")
    )  # TODO: detect multi-gpu training of clients and start external process
