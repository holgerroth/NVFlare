...
def main():
    ...
    parser.add_argument(
        "--data_path_train",
        type=str,
        default="/scratch/hroth/Code/nvflare/new_api/examples/advanced/llm_hf/dataset/dolly/training.jsonl",  # TODO: update data path to use one specific for each client
    )
    parser.add_argument(
        "--data_path_valid",
        type=str,
