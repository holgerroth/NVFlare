...
from nvflare.recipes.fedavg import (
    FedAvgRecipe, 
    SVTPrivacyPolicy, 
...
def test_recipe_with_policies():
    ...
    privacy_policies = [
        SVTPrivacyPolicy(epsilon=0.2),
        PercentilePrivacyPolicy(percentile=15)
    ]
    
    recipe = FedAvgRecipe(
        train_script="test_script.py",
        num_clients=2,
        num_rounds=1,
