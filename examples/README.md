...
| [Hello NumPy with Slurm](./hello-world/hello-numpy-slurm/README.md) | NumPy | Example in which one client submits each local training round as a CPU-only Slurm batch job. |
