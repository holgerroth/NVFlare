...
def main():
    ...
    for i in range(args.num_clients):
        ...
        nemo_cfg.model.data.train_ds.file_names = [os.path.join(args.root_dir, f"site-{i + 1}_train.jsonl"), ]
        ...
        nemo_cfg.model.data.validation_ds.file_names = [os.path.join(args.root_dir, f"site-{i + 1}_val.jsonl"), ]
