...
class CyclicRecipe(Recipe):
    """Cyclic Weight Transfer Recipe.

    This strategy implements Cyclic Weight Transfer with configurable
    ...
    def setup(self) -> FedJob:
        ...
        job = CCWFJob(name="cyclic")

        job.add_cyclic(
            server_config=CyclicServerConfig(num_rounds=self.num_rounds, max_status_report_interval=300),
