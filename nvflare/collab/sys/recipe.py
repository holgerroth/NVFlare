...
def _wrap_if_module(obj):
    ...
    - A Python module containing @collab.publish/@collab.main functions (auto-wrapped)
...
class CollabRecipe(Recipe):
    ...
    def __init__(
        ...
        Args:
            ...
            training_module: Python module to run in subprocess. If None, auto-detected
                ...
                script is separate from the client object (CollabClientAPI).
    ...
    def process_env(self, env: ExecEnv):
        ...
        from nvflare.collab.sim.sim_env import SimEnv
        from nvflare.collab.sys.poc_env import PocEnv
    ...
    def finalize(self) -> FedJob:
        print(f"CollabRecipe: Finalizing job '{self.job_name}'...")
