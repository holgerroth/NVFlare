...
from nvflare.client.constants import CONFIG_EXCHANGE, Mode
from nvflare.fuel.utils.constants import Mode as PipeMode
...
class ClientAPILauncherExecutor(LauncherExecutor):
    ...
    def prepare_config_for_launch(self, task_name: str, shareable: Shareable, fl_ctx: FLContext):
        ...
        if task_name == self._train_task_name:
            client_config.config[ConfigKey.MODE] = Mode.TRAIN
        elif task_name == self._evaluate_task_name:
            client_config.config[ConfigKey.MODE] = Mode.EVALUATE
        elif task_name == self._submit_model_task_name:
            client_config.config[ConfigKey.MODE] = Mode.SUBMIT_MODEL
    ...
    def _update_config_exchange_dict(self, config: Dict):
        ...
        config[ConfigKey.SUPPORTED_TOPICS] = [
            self._train_task_name,
            self._evaluate_task_name,
